...
function getTransformedSelections(definition, gqlType, execContext) {
    ...
    var selectionsMap = definition.selectionSet.selections.reduce(function (o, sel) {
        ...
        if (sel.kind !== 'FragmentSpread') {
            var transformed = transformDefinition(sel, gqlType, execContext);
        ...
        if (gqlType !== typeCondition) {
            ...
            var transformed = transformDefinition(node, typeCondition, execContext);
        ...
        var fragmentSelections = getTransformedSelections(fragment, typeCondition, execContext);
...
function transformDefinition(definition, type, execContext) {
    ...
    return __assign({}, definition, { selectionSet: __assign({}, definition.selectionSet, { selections: getTransformedSelections(definition, type, execContext) }) });
}
